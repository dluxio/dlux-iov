                                                                        ...
                                                                        <div class="card card-body align-items-center mx-lg-5 my-3">
                                                                            <div class="d-flex flex-column flex-grow-1 mx-1">
                                                                                ...
                                                                                <div class="d-flex flex-row flex-wrap mt-2">
                                                                                    <div v-for="(a,b,c) in contract.encryption.accounts" :class="{'bg-white' : contract.encryption.key, 'bg-white-50' : !contract.encryption.key}" class="rounded text-black filter-bubble me-1 mb-1 d-flex align-items-center" > <!-- warning class for unencrypted keys --> 
                                                                                        <div class="d-flex align-items-center">
