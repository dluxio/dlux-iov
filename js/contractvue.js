                                                                                ...
                                                                                <h2 class="mb-3">File{{pluralFiles(contract.i) ? 's' : ''}} </h2>
                                                                                    ...
                                                                                    <div v-if="flagDecode(contract.m).enc" class="mt-3">
                                                                                            ...
                                                                                            <div class="d-flex flex-column flex-grow-1">
                                                                                                ...
                                                                                                <div class="d-flex">
                                                                                                    <button v-if="!unkeyed(contract.i) && metaMismatch(contract.i)" class="btn btn-lg btn-outline-warning mx-auto" type="button" @click="update_meta(contract.i)"><i class="fa-solid fa-floppy-disk fa-fw me-2"></i>Save Changes</button>
                                                                                                </div>
                                                                                            </div>
