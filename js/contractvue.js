                                                                                                    ...
                                                                                                    <div class="bg-light rounded">    
                                                                                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                                                                            ...
                                                                                                            <g >
                                                                                                                ...
                                                                                                                <text transform="matrix(1 0 0 1 183.3494 471.9725)" class="st1 st2" style="text-transform:uppercase;font-family:'Arial-BoldMT';font-size:149px;">{{newMeta[contract.i][index * 4 + 2]}}</text>
                                                                                                            </g>
                                                                                                        </svg>
                                                                                                    </div>
