                                                                                ...
                                                                                <div class="d-flex flex-row flex-wrap">
                                                                                    <div  v-for="(a,b,c) in contract.encryption.accounts" class="rounded bg-white text-black filter-bubble me-1 mb-1 d-flex align-items-center" > <!-- warning class for unencrypted keys --> 
                                                                                        <div class="d-flex align-items-center">
                                                                                            ...
                                                                                            <div v-if="b == spkapi.name && !contract.encryption.key"><button type="button" class="ms-2 btn-close small btn-close-white" @click="decryptKey(contract.i)">Unlock</button></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <!-- update button -->
