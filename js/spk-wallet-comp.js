                            ...
                            <form name="contract">
                                <div class="modal-body text-start">
                                    <label for="broca" class="small mb-1 d-flex">Amount
                                        <span class="ms-auto">Balance: <a role="button" class="text-info"
                                                @click="amount = balance / 1000">{{formatNumber((balance)/1000, 0, '',
                                                ',')}}</a> {{token}}</span></label>
                                    <div class="position-relative mb-1">
                                        <input id="broca" class="pe-5 form-control text-white border-dark bg-dark"
                                            type="number" step="1" :min="1" :max="balance" placeholder="1"
                                            v-model="d.amount">
                                    ...
                                    <div class="position-relative mb-3" id="c_to">
                                        ...
                                        <input class="ps-4 form-control text-white border-dark bg-dark" type="text"
                                            v-model="d.to">
                                    </div>
                                    ...
                                    <div class="position-relative mb-3" id="broker">
                                        ...
                                        <select class="ps-4 form-select text-white bg-dark border-dark"
                                            id="sponsoredContracts" v-model="d.broker">
                                            <option value="" disabled selected>Select provider</option>
                                            <option v-for="(account, key) in ipfsproviders" :value="key">{{key}}
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="position-relative">
                                        <input id="ben" class="pe-5 form-control text-white border-dark bg-dark"
                                            type="number" step="0.01" :min="0" :max="100" v-model="d.ben_amount">
                                        <span class="position-absolute end-0 top-50 translate-middle-y px-2">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" @click="build"
                                        data-bs-dismiss="modal">Propose</button>
                                </div>
                            </form>
                        </div>
                    </div>
