(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.spkJs = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  "use strict";
  ...
  class Account {
    constructor() {
      ...
      this.head_block = 0;
      this.behind = 0;
      if (_config.config.account) {
        var promises = [];
        promises.push(_index.api.getAccount(_config.config.account));
        promises.push(_index.api.getStats());
        Promise.all(promises).then(res => {
          for (var key in res[0]) {
            if (this[key] != null) this[key] = res[0][key];
          }
          this.spk = _index.api.reward_spk(res[0], res[1]);
          this.broca_now = _index.api.broca_calc(this.broca, res[1].broca_refill, this.spk_power, this.head_block);
        });
      }
    }
    sendLarynx(amount, to, memo = "", test = false) {
      return new Promise((resolve, reject) => {
        this.Throw(reject);
        _index.api.checkAccount(to).then(res => {
          if (!res) throw new Error("Invalid account");
          if (this.balance < amount) throw new Error("Insufficient funds");
          var tx = {
            from: _config.config.account,
            to: to,
            amount: amount,
            memo: memo
          };
    ...
    remove(item) {
      return new Promise((resolve, reject) => {
        ...
        for (var i = 0; i < items.length; i++) {
          promises.push(_index.api.getFileContract(items[i]));
        }
        Promise.all(promises).then(res => {
          var hasItems = [];
          for (var i = 0; i < items.length; i++) {
            for (var num in res[i].result?.n) {
              if (res[i].result?.n[num] == _config.config.account) {
    ...
    registerAuthority(pubKey) {
      return new Promise((resolve, reject) => {
        ...
        if (pubKey) {
          ...
          _index.api.checkAccount(_config.config.account).then(res => {
    ...
    Throw(reject = null) {
      if (_config.config.broadcast == null) {
    ...
    channelOpen(broca, uploader, broker, benAmount = "", benAccount = "") {
      return new Promise((resolve, reject) => {
        ...
        _index.api.checkAccount(uploader).then(res => {
          if (!res) throw new Error("Invalid account");
          var slots = '',
            contract = 0;
    ...
    dexBuy(amount, rate = 0, type = " HIVE", hours = 720) {
      return new Promise((resolve, reject) => {
        this.Throw(reject);
        // check account balance
        if (rate) rate = parseFloat(rate).toFixed(6);else rate = null;
        var op = [_config.config.account, [["transfer", {
          "to": "spk-cc",
          "from": _config.config.account,
    ...
    dexSell(amount, rate = 0, type = "HIVE", hours = 720) {
      return new Promise((resolve, reject) => {
        ...
        if (type != "HIVE") type = "hbd";else type = "hive";
        if (!hours) hours = 720;else if (hours < 720) hours = parseInt(hours);
    ...
    setAccount(account) {
      return new Promise((resolve, reject) => {
        _config.config.account = account;
        var promises = [];
        promises.push(_index.api.getAccount(_config.config.account));
        promises.push(_index.api.getStats());
        Promise.all(promises).then(res => {
          ...
          this.spk_now = this.spk + (typeof _index.api.reward_spk(res[0], this.stats) == "number" ? _index.api.reward_spk(res[0], this.stats) : 0);
          this.broca_now = _index.api.broca_calc(this.broca, this.stats.broca_refill, this.spk_power, this.head_block);
          resolve({
  ...
  },{"./../api/index.js":2,"./../config.js":4}],2:[function(require,module,exports){
  "use strict";
  ...
  class Api {
    constructor() {
      for (var i = 0; i < _methods.calls.length; i++) {
        const call = _methods.calls[i];
        this[call.action] = makeFunc(call);
      }
    }
    setSpkNode(url) {
      _config.config.spk_node = url;
    }
    setHiveNode(url) {
      _config.config.node = url;
    }
    setSignFunction(func) {
      if (typeof func != "function") throw new Error("Sign function must be a function");
      _config.config.sign = func;
    }
    checkAccount(account) {
      return new Promise((resolve, reject) => {
        fetch(_config.config.node, {
  ...
  function makeFunc(call) {
    return async function () {
      ...
      var url = _config.config.spk_node + path;
  ...
  },{"./../config.js":4,"./methods.js":3}],3:[function(require,module,exports){
  "use strict";
  ...
  var config = {
    ...
    sign: function (op) {
      return new Promise((res, rej) => {
        console.log(op);
        window.hive_keychain.requestSignBuffer(op[0], `${op[0]}:${op[1]}`, op[2], sig => {
          if (sig.error) rej(sig);else res(sig.result);
        });
      });
    },
    broadcast: function (op) {
      return new Promise((resolve, reject) => {
        if (window.hive_keychain) {
          ...
          reject({
            error: "Hive Keychain is not installed."
          }); //fallthrough?
        }
      });
    }
  ...
  class file {
    ...
    selectTroleAPI(broker) {
      _index.api.getServicesByUser(broker).then(res => {
    ...
    selectContract(id) {
      _index.api.getFileContract(id).then(res => {
        this.troleQty = res?.services?.s?.i.split('IPFS:')[1].split(',').length;
        this.contract.api = res?.services?.IPFS[res?.services?.s?.i.split('IPFS:')[1].split(',')[this.troleIndex]].api;
        fetch(`${this.contract.api}/upload-stats`).then(res => res.json()).then(res => {
          if (res?.node == broker) {
    ...
    upload(cids = ['QmYJ2QP58rXFLGDUnBzfPSybDy3BnKNsDXh6swQyH7qim3'], contract = {
      ...
      const retryFileUpload = file => {
        ...
        if (fileReq) {
          ...
          return fetch(`${ENDPOINTS.UPLOAD_STATUS}?fileName=${file.name}&fileId=${fileReq.options.fileId}`).then(res => res.json()).then(res => {
      ...
      const resumeFileUpload = file => {
        ...
        if (fileReq) {
          return fetch(`${ENDPOINTS.UPLOAD_STATUS}`, {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
              'sig': contract.fosig,
  ...
  },{"./../api/index.js":2,"./../config.js":4,"ipfs-only-hash":42}],6:[function(require,module,exports){
  "use strict";
  ...
  var _index = require("./api/index.js");
  var _index2 = require("./file/index.js");
  var _index3 = require("./account/index.js");
  
  },{"./account/index.js":1,"./api/index.js":2,"./file/index.js":5}],7:[function(require,module,exports){
  "use strict";
  ...
  },{"base64-js":16,"buffer":22,"ieee754":41}],23:[function(require,module,exports){
  'use strict';
  ...
  },{"./util/as-uint8array.js":27}],24:[function(require,module,exports){
  'use strict';
  ...
  },{"./alloc.js":23,"./util/as-uint8array.js":27}],25:[function(require,module,exports){
  'use strict';
  ...
  },{"./util/bases.js":28}],27:[function(require,module,exports){
  'use strict';
  ...
  },{"../alloc.js":23,"multiformats/basics":109}],29:[function(require,module,exports){
  'use strict';
  ...
  },{"multihashes":133}],30:[function(require,module,exports){
  'use strict';
  ...
  },{"./cid-util":29,"multibase":85,"multicodec":95,"multihashes":133,"uint8arrays/concat":24,"uint8arrays/equals":25,"uint8arrays/to-string":26}],31:[function(require,module,exports){
  'use strict';
  ...
  },{"./util/as-uint8array.js":35,"dup":23}],33:[function(require,module,exports){
  arguments[4][24][0].apply(exports,arguments)
  },{"./alloc.js":32,"./util/as-uint8array.js":35,"dup":24}],34:[function(require,module,exports){
  'use strict';
  ...
  },{"./util/as-uint8array.js":35,"./util/bases.js":36}],35:[function(require,module,exports){
  arguments[4][27][0].apply(exports,arguments)
  },{"dup":27}],36:[function(require,module,exports){
  arguments[4][28][0].apply(exports,arguments)
  },{"../alloc.js":32,"dup":28,"multiformats/basics":109}],37:[function(require,module,exports){
  'use strict';
  ...
  },{"sparse-array":161,"uint8arrays/from-string":34}],38:[function(require,module,exports){
  'use strict';
  ...
  },{"./consumable-buffer":38,"uint8arrays/concat":33}],40:[function(require,module,exports){
  'use strict';
  ...
  },{"./bucket":37,"./consumable-hash":39}],41:[function(require,module,exports){
  ...
  },{"ipfs-unixfs-importer":57}],43:[function(require,module,exports){
  'use strict';
  ...
  },{"bl/BufferList":17}],44:[function(require,module,exports){
  'use strict';
  ...
  },{"bl/BufferList":17,"err-code":31,"rabin-wasm":159}],45:[function(require,module,exports){
  'use strict';
  ...
  },{"../utils/persist":60,"ipfs-unixfs":62,"ipld-dag-pb":73}],46:[function(require,module,exports){
  'use strict';
  ...
  },{"it-batch":79}],47:[function(require,module,exports){
  'use strict';
  ...
  },{"../../utils/persist":60,"ipfs-unixfs":62,"ipld-dag-pb":73}],48:[function(require,module,exports){
  'use strict';
  ...
  },{"it-all":78}],49:[function(require,module,exports){
  'use strict';
  ...
  },{"../../utils/persist":60,"./balanced":46,"./buffer-importer":47,"./flat":48,"./trickle":50,"err-code":31,"ipfs-unixfs":62,"ipld-dag-pb":73,"it-parallel-batch":80,"multihashing-async":141}],50:[function(require,module,exports){
  'use strict';
  ...
  },{"it-batch":79}],51:[function(require,module,exports){
  'use strict';
  ...
  },{"../chunker/fixed-size":43,"../chunker/rabin":44,"./dir":45,"./file":49,"./validate-chunks":52,"err-code":31}],52:[function(require,module,exports){
  'use strict';
  ...
  },{"err-code":31,"uint8arrays/from-string":165}],53:[function(require,module,exports){
  'use strict';
  ...
  },{"./dir":55,"./utils/persist":60,"ipfs-unixfs":62,"ipld-dag-pb":73}],54:[function(require,module,exports){
  'use strict';
  ...
  },{"./dir":55,"./utils/persist":60,"hamt-sharding":40,"ipfs-unixfs":62,"ipld-dag-pb":73}],55:[function(require,module,exports){
  'use strict';
  ...
  },{"./dir-flat":53,"./dir-sharded":54}],57:[function(require,module,exports){
  'use strict';
  ...
  },{"./dag-builder":51,"./options":58,"./tree-builder":59,"it-parallel-batch":80}],58:[function(require,module,exports){
  'use strict';
  ...
  },{"merge-options":82,"multihashing-async":141}],59:[function(require,module,exports){
  'use strict';
  ...
  },{"./dir":55,"./dir-flat":53,"./flat-to-shard":56,"./utils/to-path-components":61}],60:[function(require,module,exports){
  'use strict';
  ...
  },{"cids":30,"multihashing-async":141}],61:[function(require,module,exports){
  'use strict';
  ...
  },{"./unixfs":63,"err-code":31}],63:[function(require,module,exports){
  /*eslint-disable*/
  "use strict";
  ...
  },{"protobufjs/minimal":147}],64:[function(require,module,exports){
  'use strict';
  ...
  },{"cids":30,"uint8arrays/from-string":165}],65:[function(require,module,exports){
  'use strict';
  ...
  },{"./dagLink":64}],66:[function(require,module,exports){
  'use strict';
  ...
  },{"../dag-link/dagLink":64,"./sortLinks":69}],67:[function(require,module,exports){
  'use strict';
  ...
  },{"../dag-link/dagLink":64,"../dag-link/util":65,"../serialize":75,"./addLink":66,"./rmLink":68,"./sortLinks":69,"./toDagLink":70,"uint8arrays/from-string":165,"uint8arrays/to-string":166}],68:[function(require,module,exports){
  'use strict';
  ...
  },{"cids":30,"uint8arrays/equals":164}],69:[function(require,module,exports){
  'use strict';
  ...
  },{"stable":162,"uint8arrays/compare":163}],70:[function(require,module,exports){
  'use strict';
  ...
  },{"../dag-link/dagLink":64,"../genCid":72}],71:[function(require,module,exports){
  /*eslint-disable*/
  "use strict";
  ...
  },{"protobufjs/minimal":147}],72:[function(require,module,exports){
  'use strict';
  ...
  },{"cids":30,"multicodec":95,"multihashing-async":141}],73:[function(require,module,exports){
  'use strict';
  ...
  },{"./dag-link/dagLink":64,"./dag-node/dagNode":67,"./resolver":74,"./util":76}],74:[function(require,module,exports){
  'use strict';
  ...
  },{"./util":76,"cids":30}],75:[function(require,module,exports){
  'use strict';
  ...
  },{"./dag":71,"./dag-link/util":65,"protobufjs/minimal":147}],76:[function(require,module,exports){
  'use strict';
  ...
  },{"./dag":71,"./dag-link/dagLink":64,"./dag-node/dagNode":67,"./genCid":72,"./serialize":75}],77:[function(require,module,exports){
  'use strict';
  ...
  },{"it-batch":79}],81:[function(require,module,exports){
  ...
  },{"_process":146}],82:[function(require,module,exports){
  'use strict';
  ...
  },{"is-plain-obj":77}],83:[function(require,module,exports){
  'use strict';
  ...
  },{"./util":87}],84:[function(require,module,exports){
  'use strict';
  ...
  },{"./base.js":83,"./rfc4648":86,"./util":87,"@multiformats/base-x":8}],85:[function(require,module,exports){
  /**
  ...
  },{"./constants":84,"./util":87}],86:[function(require,module,exports){
  'use strict';
  ...
  arguments[4][23][0].apply(exports,arguments)
  },{"./util/as-uint8array.js":92,"dup":23}],89:[function(require,module,exports){
  arguments[4][24][0].apply(exports,arguments)
  },{"./alloc.js":88,"./util/as-uint8array.js":92,"dup":24}],90:[function(require,module,exports){
  arguments[4][34][0].apply(exports,arguments)
  },{"./util/as-uint8array.js":92,"./util/bases.js":93,"dup":34}],91:[function(require,module,exports){
  arguments[4][26][0].apply(exports,arguments)
  },{"./util/bases.js":93,"dup":26}],92:[function(require,module,exports){
  arguments[4][27][0].apply(exports,arguments)
  },{"dup":27}],93:[function(require,module,exports){
  arguments[4][28][0].apply(exports,arguments)
  },{"../alloc.js":88,"dup":28,"multiformats/basics":109}],94:[function(require,module,exports){
  ...
  },{"./maps":96,"./util":97,"uint8arrays/concat":89,"varint":170}],96:[function(require,module,exports){
  'use strict';
  ...
  },{"./generated-table":94,"./util":97}],97:[function(require,module,exports){
  'use strict';
  ...
  },{"uint8arrays/from-string":90,"uint8arrays/to-string":91,"varint":170}],98:[function(require,module,exports){
  'use strict';
  ...
  },{"../../vendor/base-x.js":120,"../bytes.js":110}],99:[function(require,module,exports){
  'use strict';
  ...
  },{"./base.js":98}],100:[function(require,module,exports){
  'use strict';
  ...
  },{"./base.js":98}],101:[function(require,module,exports){
  'use strict';
  ...
  },{"./base.js":98}],102:[function(require,module,exports){
  'use strict';
  ...
  },{"./base.js":98}],103:[function(require,module,exports){
  'use strict';
  ...
  },{"./base.js":98}],104:[function(require,module,exports){
  'use strict';
  ...
  },{"./base.js":98}],105:[function(require,module,exports){
  'use strict';
  ...
  },{"./base.js":98}],106:[function(require,module,exports){
  'use strict';
  ...
  },{"./base.js":98}],107:[function(require,module,exports){
  'use strict';
  ...
  },{"./base.js":98}],108:[function(require,module,exports){
  'use strict';
  ...
  },{"../bytes.js":110,"./base.js":98}],109:[function(require,module,exports){
  'use strict';
  ...
  },{"./bases/base10.js":99,"./bases/base16.js":100,"./bases/base2.js":101,"./bases/base256emoji.js":102,"./bases/base32.js":103,"./bases/base36.js":104,"./bases/base58.js":105,"./bases/base64.js":106,"./bases/base8.js":107,"./bases/identity.js":108,"./bytes.js":110,"./cid.js":111,"./codecs/json.js":112,"./codecs/raw.js":113,"./hashes/digest.js":114,"./hashes/hasher.js":115,"./hashes/identity.js":116,"./hashes/sha2.js":117,"./index.js":118,"./varint.js":119}],110:[function(require,module,exports){
  'use strict';
  ...
  },{"./bases/base32.js":103,"./bases/base58.js":105,"./bytes.js":110,"./hashes/digest.js":114,"./varint.js":119}],112:[function(require,module,exports){
  'use strict';
  ...
  },{"../bytes.js":110}],114:[function(require,module,exports){
  'use strict';
  ...
  },{"../bytes.js":110,"../varint.js":119}],115:[function(require,module,exports){
  'use strict';
  ...
  },{"./digest.js":114}],116:[function(require,module,exports){
  'use strict';
  ...
  },{"../bytes.js":110,"./digest.js":114}],117:[function(require,module,exports){
  'use strict';
  ...
  },{"./hasher.js":115}],118:[function(require,module,exports){
  'use strict';
  ...
  },{"./bytes.js":110,"./cid.js":111,"./hashes/digest.js":114,"./hashes/hasher.js":115,"./varint.js":119}],119:[function(require,module,exports){
  'use strict';
  ...
  },{"../vendor/varint.js":121}],120:[function(require,module,exports){
  'use strict';
  ...
  arguments[4][23][0].apply(exports,arguments)
  },{"./util/as-uint8array.js":126,"dup":23}],123:[function(require,module,exports){
  arguments[4][24][0].apply(exports,arguments)
  },{"./alloc.js":122,"./util/as-uint8array.js":126,"dup":24}],124:[function(require,module,exports){
  arguments[4][34][0].apply(exports,arguments)
  },{"./util/as-uint8array.js":126,"./util/bases.js":127,"dup":34}],125:[function(require,module,exports){
  arguments[4][26][0].apply(exports,arguments)
  },{"./util/bases.js":127,"dup":26}],126:[function(require,module,exports){
  arguments[4][27][0].apply(exports,arguments)
  },{"dup":27}],127:[function(require,module,exports){
  arguments[4][28][0].apply(exports,arguments)
  },{"../alloc.js":122,"dup":28,"multiformats/basics":109}],128:[function(require,module,exports){
  module.exports = read;
  var MSB = 0x80,
    REST = 0x7F;
  function read(buf, offset) {
  ...
  },{"./decode.js":128,"./encode.js":129,"./length.js":131}],131:[function(require,module,exports){
  var N1 = Math.pow(2, 7);
  var N2 = Math.pow(2, 14);
  var N3 = Math.pow(2, 21);
  var N4 = Math.pow(2, 28);
  ...
  },{"./constants":132,"multibase":85,"uint8arrays/concat":123,"uint8arrays/from-string":124,"uint8arrays/to-string":125,"varint":130}],134:[function(require,module,exports){
  arguments[4][23][0].apply(exports,arguments)
  },{"./util/as-uint8array.js":137,"dup":23}],135:[function(require,module,exports){
  arguments[4][25][0].apply(exports,arguments)
  },{"dup":25}],136:[function(require,module,exports){
  arguments[4][34][0].apply(exports,arguments)
  },{"./util/as-uint8array.js":137,"./util/bases.js":138,"dup":34}],137:[function(require,module,exports){
  arguments[4][27][0].apply(exports,arguments)
  },{"dup":27}],138:[function(require,module,exports){
  arguments[4][28][0].apply(exports,arguments)
  },{"../alloc.js":134,"dup":28,"multiformats/basics":109}],139:[function(require,module,exports){
  'use strict';
  ...
  },{"blakejs":20}],140:[function(require,module,exports){
  'use strict';
  ...
  },{"./blake":139,"./sha":142,"./utils":143,"js-sha3":81,"murmurhash3js-revisited":144,"uint8arrays/from-string":136}],141:[function(require,module,exports){
  'use strict';
  ...
  },{"./crypto":140,"err-code":31,"multihashes":133,"uint8arrays/equals":135}],142:[function(require,module,exports){
  ...
  },{"multihashes":133}],143:[function(require,module,exports){
  'use strict';
  ...
  },{"./lib/murmurHash3js":145}],145:[function(require,module,exports){
  /* jshint -W086: true */
  // +----------------------------------------------------------------------+
  ...
  },{"./src/index-minimal":148}],148:[function(require,module,exports){
  "use strict";
  ...
  },{"./reader":149,"./reader_buffer":150,"./roots":151,"./rpc":152,"./util/minimal":155,"./writer":156,"./writer_buffer":157}],149:[function(require,module,exports){
  "use strict";
  ...
  },{"./util/minimal":155}],150:[function(require,module,exports){
  "use strict";
  ...
  },{"./reader":149,"./util/minimal":155}],151:[function(require,module,exports){
  "use strict";
  ...
  },{"./rpc/service":153}],153:[function(require,module,exports){
  "use strict";
  ...
  },{"../util/minimal":155}],154:[function(require,module,exports){
  "use strict";
  ...
  },{"../util/minimal":155}],155:[function(require,module,exports){
  ...
  },{"./longbits":154,"@protobufjs/aspromise":9,"@protobufjs/base64":10,"@protobufjs/eventemitter":11,"@protobufjs/float":12,"@protobufjs/inquire":13,"@protobufjs/pool":14,"@protobufjs/utf8":15}],156:[function(require,module,exports){
  "use strict";
  ...
  },{"./util/minimal":155}],157:[function(require,module,exports){
  "use strict";
  ...
  },{"./util/minimal":155,"./writer":156}],158:[function(require,module,exports){
  const {
    instantiate
  ...
  },{"@assemblyscript/loader":7}],159:[function(require,module,exports){
  ...
  },{"../dist/rabin-wasm.node.js":158,"./rabin":160}],160:[function(require,module,exports){
  "use strict";
  ...
  },{"./util/bases":167}],166:[function(require,module,exports){
  'use strict';
  ...
  },{"./util/bases":167}],167:[function(require,module,exports){
  'use strict';
  ...
  },{"multiformats/basics":109}],168:[function(require,module,exports){
  module.exports = read;
  var MSB = 0x80,
    REST = 0x7F;
  function read(buf, offset) {
  ...
  },{"./decode.js":168,"./encode.js":169,"./length.js":171,"dup":130}],171:[function(require,module,exports){
