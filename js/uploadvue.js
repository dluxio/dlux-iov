                ...
                <div id="listOfImgs" v-if="!encryption.encrypted" v-for="(file, key,index) in FileInfo">
                    <div class="p-3 mb-2 card card-body bg-black" style="border-radius: 10px;"
                        ...
                        <div class="d-flex w-100" v-if="FileInfo[file.name]">
                            ...
                            <div class="">Bytes: {{fancyBytes(File[FileInfo[file.name].index].size)}}</div <div
                                class="">CID:
                            {{FileInfo[file.name].hash}}
                        </div>
                        <div class="">Status:
                            {{FileInfo[file.name].status}}
                        </div>
                        <div class=""><a :href="'https://ipfs.dlux.io/ipfs/' + FileInfo[file.name].hash"
                              ...
                              <div class="col-md-8"> 
                                  ...
                                  <div class="mb-1">    
                                      ...
                                      <div class="input-group">
                                          <input autocapitalize="off" placeholder="File Name" pattern="[a-zA-Z0-9]{3,25}" class="form-control"><!-- v-model="newMeta[contract.i][index * 4 + 1]" -->
                                          <span class="input-group-text">.</span>
                                          <input autocapitalize="off" placeholder="File Type" pattern="[a-zA-Z0-9]{1,4}" class="form-control"><!-- v-model="newMeta[contract.i][index * 4 + 2]" -->
                                      </div>
                                  </div>
                                  <div class="mb-1">
                                      <label class="mb-1">Thumbnail</label>
                                      <div class="position-relative has-validation">
                                          <input autocapitalize="off" placeholder="https://your-thumbnail-image.png" pattern="https:\/\/[a-z0-9.-\/]+|Qm[a-zA-Z0-9]+" class="form-control"><!-- v-model="newMeta[contract.i][index * 4 + 3]" -->
                                      </div>
                                  </div>
                                  ...
                                  <div class="mb-1">
                                      ...
                                      <choices-vue ref="select-tag" prop_type="tags" @data="handleTag(contract.i, index * 4 + 4, $event)"></choices-vue><!-- :prop_selections="newMeta[contract.i][index * 4 + 4]" -->
                                  </div>
                                  <div class="mb-1">
                                      <label class="mb-1">Labels</label>
                                      <choices-vue ref="select-label"  prop_type="labels" @data="handleLabel(contract.i, index * 4 + 4, $event)"></choices-vue><!-- :prop_selections="newMeta[contract.i][index * 4 + 4]" -->
                                  </div> 
