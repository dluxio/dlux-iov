                                                            ...
                                                            <td class="border-0 px-0 px-md-1" colspan="4">
                                                                <div class="d-flex flex-column border border-white rounded text-start py-2" style="background-color:rgba(0,0,0,0.3);">
                                                                        ...
                                                                        <div class="mx-1" v-if="contract.c > 2"> 
                                                                            <div class="gradient-border bg-dark mb-3 p-sm-1 p-lg-2"> 
                                                                                <div class="d-flex flex-wrap justify-content-around justify-content-md-between mx-1 mx-md-2 pt-1 pt-md-2">
                                                                                   ...
                                                                                   <div class="input-group-text">
                                                                                        <div class="form-check form-switch fs-5" :class="{'is-danger': !saccountapi.spk}">
                                                                                            <input class="form-check-input" type="checkbox" checked="" role="switch" :id="contract.i + 'autoRenew'" v-model="localNewMeta[contract.i].contract.autoRenew" :class="{'disabled': contract.t != account}" :disabled="contract.t != account">
                                                                                ...
                                                                                <div class="d-flex text-center">
                                                                                    <button v-if="contract.c > 1 && metaMismatch(contract.i) && !localNewMeta[contract.i].contract.encrypted" 
                                                                                        class="btn btn-lg btn-outline-warning mx-auto my-2" 
                                                                                        type="button" 
                                                                                        @click="update_meta(contract.i)">
                                                                                        <i class="fa-solid fa-floppy-disk fa-fw me-2"></i>Save Metadata
                                                                                    </button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="mb-3 p-sm-1 p-lg-2 rounded" style="background-color:rgba(0,0,0,0.3)">
                                                                            <div class="d-flex flex-column">
                                                                                ...
                                                                                <div v-for="(size, cid, index) in contract.df">
                                                                                    <div v-if="!localNewMeta[contract.i][cid].is_thumb" class="mt-2 rounded card p-2">
                                                                                        ...
                                                                                        <div class="row align-items-center"> 
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="d-flex flex-column justify-content-center">
                                                                                                    ...
                                                                                                    <img v-if="localNewMeta[contract.i][cid].thumb && isValidThumb(localNewMeta[contract.i][cid].thumb_data)" class="mx-auto img-fluid rounded bg-light" :src="localNewMeta[contract.i][cid].thumb_data" width="314px" >
                                                                                                    <div v-else class="bg-light rounded">    
                                                                                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                                                                            ...
                                                                                                            <g >
                                                                                                                ...
                                                                                                                <text transform="matrix(1 0 0 1 233.3494 471.9725)" class="st1 st2" style="text-transform: uppercase; font-size: 149px;">{{localNewMeta[contract.i][cid].type}}</text>
                                                                                                            </g>
                                                                                                        </svg>
                                                                                                    </div>
                                                                                                    ...
                                                                                                    <!-- link -->
                                                                                                    <div v-if="!localNewMeta[contract.i][cid].encrypted">
                                                                                                    ...
                                                                                                    <!-- download  -->
                                                                                                    <div class="d-none" v-if="!localNewMeta[contract.i][cid].encrypted">
                                                                                                    ...
                                                                                                    <!-- decrypt  -->
                                                                                                    <div v-if="localNewMeta[contract.i][cid].encrypted && !contract.encryption.key">
                                                                                            ...
                                                                                            <div class="col-md-8"> 
                                                                                                ...
                                                                                                <div class="mb-1">    
                                                                                                    ...
                                                                                                    <div class="input-group">
                                                                                                        <input autocapitalize="off" v-model="localNewMeta[contract.i][cid].name" placeholder="File Name" pattern="[a-zA-Z0-9]{3,25}" class="form-control bg-dark border-0" :class="{'text-info': contract.t == account, 'text-white': contract.t != account}" :disabled="contract.t != account">
                                                                                                        <span class="input-group-text bg-dark border-0">.</span>
                                                                                                        <input autocapitalize="off" v-model="localNewMeta[contract.i][cid].type" placeholder="File Type" pattern="[a-zA-Z0-9]{1,4}" class="form-control bg-dark border-0" :class="{'text-info': contract.t == account, 'text-white': contract.t != account}" :disabled="contract.t != account">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="mb-1">
                                                                                                    <label class="mb-1">Thumbnail</label>
                                                                                                    <div class="position-relative has-validation">
                                                                                                        <input autocapitalize="off" v-model="localNewMeta[contract.i][cid].thumb" @change="getImgData(contract.i, cid)" placeholder="https://your-thumbnail-image.png" pattern="(https:\/\/[a-z0-9.-\/]+)|(Qm[a-zA-Z0-9]+)" class="form-control bg-dark border-0" :class="{'text-info': contract.t == account, 'text-white': contract.t != account}" :disabled="contract.t != account">
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="mb-1">
                                                                                                    ...
                                                                                                    <choices-vue ref="select-tag" :prop_selections="localNewMeta[contract.i][cid].flags" prop_type="tags" @data="handleTag(contract.i, cid, $event)" :class="{'text-info': contract.t == account, 'text-white disabled': contract.t != account}" :disabled="contract.t != account"></choices-vue>
                                                                                                </div>
                                                                                                <div class="mb-1">
                                                                                                    <label class="mb-1">License</label>
                                                                                                    <choices-vue ref="select-tag" :prop_selections="localNewMeta[contract.i][cid].license" prop_type="license" @data="handleLicense(contract.i, cid, $event)" :class="{'text-info': contract.t == account, 'text-white': contract.t != account}" :disabled="contract.t != account"></choices-vue>
                                                                                                </div>
                                                                                                <div class="mb-1">
                                                                                                    <label class="mb-1">Labels</label>
                                                                                                    <choices-vue ref="select-label" :prop_selections="localNewMeta[contract.i][cid].labels" prop_type="labels" @data="handleLabel(contract.i, cid, $event)" :class="{'text-info': contract.t == account, 'text-white': contract.t != account}" :disabled="contract.t != account"></choices-vue>
                                                                                                </div> 
                                                                                ...
                                                                                <div v-for="(size, cid, index) in contract.df">
                                                                                    <div v-if="localNewMeta[contract.i][cid].is_thumb" class="mt-2 rounded bg-dark p-2">
                                                                                        Thumb: {{getdelimed(localNewMeta[contract.i][cid].name, 'thumb', 1)}}.{{localNewMeta[contract.i][cid].type}} - {{cid}} - {{fancyBytes(size)}}
                                                                                    </div>
                                                                                </div>
                                                                                <!-- encrypted sharing  -->
                                                                                <div v-if="contract.c > 1 && localNewMeta[contract.i].contract.encrypted" class="mt-3">
                                                                    ...
                                                                    <div class="d-flex flex-wrap justify-content-center my-3 small">
                                                                        ...
                                                                        <div class="d-flex align-items-center px-3 py-1 m-1 rounded-pill border border-white" v-if="localNewMeta[contract.i]">
                                                                            <div> Privacy </div>
                                                                            <i class="fa-solid fa-fw mx-1" :class="{'fa-lock-open': !localNewMeta[contract.i].contract.encrypted, 'fa-lock': localNewMeta[contract.i].contract.encrypted}" aria-hidden="true"></i>
                                                                            <div>{{localNewMeta[contract.i].contract.encrypted ? 'Private' : 'Public'}}</div>
                                                                        </div>
                                                                         <div class="d-flex align-items-center px-3 py-1 m-1 rounded-pill border border-white">
                                                                            <div> Nodes </div>
