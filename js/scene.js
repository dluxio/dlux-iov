export default {
  ...
  <a-scene antialias="true">
        ...
        <a-entity id="portalsHolder" position="1 1.6 -1" rotation="0 58 0" layout="type: circle; radius: 10;angle: 15;plane:xz">
            <a-entity v-for="post in displayPosts" >
            <a-entity v-if="get360(post) != 'QmeDDfa2QUUhuTvVJrEQNRNB1qBCJCjUKmx2enmVjLqP8H'" class="poster-image" :material="'side:double;src:#portal-' + post.author + post.permlink + ';'" show-info="" geometry="primitive:sphere" crossorigin="anonymous" position="0 0 0" rotation="0 180 0" scale="1 1 1">
                ...
                <a-entity class="hidebutton" look-at="[camera]" @mouseenter="visible = true" visible="false" position="0 1.2 0">
                    <a-entity class="col-1" position="0 3.6 0">
                        ...
                        <a-entity class="r2-author" geometry="primitive:plane;width:6;height:1" material="side:double;color:#25D193;opacity:0.7" position="0 -0.5 0" rotation="0 0 0" url="/@">
                            <a-entity v-if="authors[post.author]" class="author-pic" geometry="primitive:circle;radius:0.45" :material="'side:double;src:#author-' + post.author + ';'" crossorigin="anonymous" position="-2.34 0 0.1" scale="1 1 1"></a-entity>
    ...
    data() {
      ...
      methods: {
        ...
        get360(post){
            ...
            return 'QmeDDfa2QUUhuTvVJrEQNRNB1qBCJCjUKmx2enmVjLqP8H'
        },
        tokenSend() {
